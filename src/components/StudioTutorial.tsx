...
const STEPS: TutorialStep[] = [
  {
    ...
    body: 'Start by choosing what you want to build! Pick a game starter or just describe any idea in the chat.',
    nextLabel: 'Next',
    mobileTab: 'chat',
  },
  {
    ...
    body: "Now make it yours! Describe the vibe you want. Try: 'make it a jungle theme' or 'set it in outer space'. One change at a time works best.",
    mobileTab: 'chat',
  },
  {
    ...
    body: "The AI is building your creation right now! When it's done, you'll see it appear here. Click 'Play My Creation!' to try it out.",
    mobileTab: 'game',
  },
  {
    targetSelector: '.chat-input-area',
    position: 'top',
    title: 'Make It Yours',
    body: "Don't like something? Just ask! Try: 'change the colors' or 'make it faster' or 'add more pages'. One change at a time works best.",
    mobileTab: 'chat',
  },
  {
    ...
    position: 'top',
    title: 'Power Moves',
    body: "These buttons level up your creation: 'Make It Fun' adds creative surprises. 'Team Up' has two AIs work together to make something amazing. Try them!",
    nextLabel: "Let's go!",
    mobileTab: 'chat',
  },
];
