...
export const STARTER_TEMPLATES: StarterTemplateCard[] = [
  ...
  },
  {
    ...
    label: 'Chess',
    shortLabel: 'Chess',
    description: 'Plan smart moves on a classic board',
    icon: '♟️',
    engineId: 'vibe-2d',
    dimension: '2d',
    genreFamily: 'puzzleCasual',
    defaultTheme: 'royal castle',
    defaultCharacter: 'chess pieces',
    defaultObstacle: 'smart strategy',
    promptHint: 'Best starter for chess boards, turn-based strategy, and piece movement games.',
    gradient: 'linear-gradient(135deg, #0f172a 0%, #312e81 55%, #cbd5f5 100%)',
  },
  {
    id: 'platformer',
    label: 'Platformer',
