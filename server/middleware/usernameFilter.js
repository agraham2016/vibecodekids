...
const LAST_NAME_PATTERNS = [/^(mc|mac|o'|de|van|von|al|el|la|le|di|da|du|st)\s*[a-z]+$/i];
...
export function filterUsername(name) {
  ...
  for (const re of PII_PATTERNS) {
    if (re.test(lower)) {
      return {
        blocked: true,
        reason: "Your username contains personal information. Pick something that doesn't reveal info about you!",
      };
    }
  }
