...
function rowToUser(row) {
  ...
  return {
    ...
    parentAcceptedTerms: row.parent_accepted_terms ?? false,
    parentAcceptedTermsAt: row.parent_accepted_terms_at?.toISOString() || null,
...
function userToRow(user) {
  return {
    ...
    parent_accepted_terms: user.parentAcceptedTerms ?? false,
    parent_accepted_terms_at: user.parentAcceptedTermsAt || null,
...
export async function writeUser(userId, userData) {
  ...
  await db.query(
    ...
    INSERT INTO users (
      ...
      data_deletion_requested, data_deletion_at, privacy_accepted_at, parent_accepted_terms, parent_accepted_terms_at,
    ...
    ON CONFLICT (id) DO UPDATE SET
      ...
      parent_accepted_terms = EXCLUDED.parent_accepted_terms,
      parent_accepted_terms_at = EXCLUDED.parent_accepted_terms_at,
  ...
  `,
    [
      ...
      r.parent_accepted_terms,
      r.parent_accepted_terms_at,
      r.approved_at,
      r.denied_at,
      r.created_at,
      r.last_login_at,
