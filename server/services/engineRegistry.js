...
export const ENGINE_FAMILY_PROFILES = {
  ...
  towerDefense3d: {
    ...
    coreSystems: ['tile grid', 'enemy path', 'tower placement', 'wave system', 'currency loop', 'projectile system'],
    safeEditSurfaces: ['tower types', 'enemy types', 'map layout', 'wave pacing', 'upgrade costs'],
    architecture: createArchitecture('3d', {
      inputModel: 'click or tap to place towers on valid tiles, wave start button',
